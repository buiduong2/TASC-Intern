...
public class EntityLookupHelper {
    ...
    public <R extends JpaRepository<E, Long>, E extends GetIdAble<Long>> E findById(R r, long id, String name) {

        return r.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException(name + " id = " + id + " Not found"));
    }

    public <R extends JpaRepository<E, Long>, E extends GetIdAble<Long>> List<E> findByIdIn(R r, List<Long> ids,
            String name) {
    ...
    public <R extends JpaRepository<E, Long>, E extends GetIdAble<Long>> Map<Long, E> findMapByIdIn(R r,
            List<Long> ids,
            String name) {
