...
import { ArrowDownIcon, ArrowUpIcon, EllipsisIcon, EyeClosedIcon } from 'lucide-vue-next'
    ...
    <DropdownMenu>
      <DropdownMenuTrigger as-child>
        <Button variant="ghost" size="sm" class="-ml-3 h-8 data-[state=open]:bg-accent">
          ...
          <EllipsisIcon v-else class="w-4 h-4 ml-2" />
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="start">
        ...
        <DropdownMenuItem @click="column.toggleSorting()">
          <ArrowDownIcon class="mr-2 h-3.5 w-3.5 text-muted-foreground/70" />
          No Sort
        </DropdownMenuItem>
        <DropdownMenuSeparator />
