...
@Setter
@NoArgsConstructor
public class OrderCreationRequestedEvent extends AbstractSagaEvent {

    private LinkedHashSet<OrderItemData> items;

    public OrderCreationRequestedEvent(long orderId, long userId, LinkedHashSet<OrderItemData> items) {
