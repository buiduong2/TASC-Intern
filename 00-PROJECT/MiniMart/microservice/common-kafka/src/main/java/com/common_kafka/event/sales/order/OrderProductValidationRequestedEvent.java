...
@Setter
@NoArgsConstructor
public class OrderProductValidationRequestedEvent extends AbstractSagaEvent {

    private LinkedHashSet<OrderItemData> items;

    public OrderProductValidationRequestedEvent(long orderId, long userId, LinkedHashSet<OrderItemData> items) {
