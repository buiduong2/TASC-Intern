...
public class CacheUtils {
    ...
    public static final Duration PRODUCT_DETAIL_TTL = Duration.ofHours(24);

    // product-service::product:ids:by-category::{categoryId} List<ProductId>
    ...
    public static final Duration PRODUCT_RELATE_TTL = Duration.ofHours(24);
